...
| /feedback   | Adds an unrecognized booking to the training set and retrains the classifier model.<br/>The category must be provided by the user. <br/>**Note**: Needs the training set which is not part of this repository! | POST         | {"category":" ", "booking_date":" ","valuta_date":" ","text":" ","usage":" ","creditor_id":" ","owner":" ","iban":" ","bic":" ","amount':" "} | 
